    ...
    public function showForm()
{
    ...
    $tax = 0; // Implement your tax calculation logic here
    $shippingCost = 0; // Implement your shipping cost logic here

    // Calculate total cost including subtotal, discount, tax, and shipping cost
    $totalCost = $subTotal - $discount + $tax + $shippingCost;

    return view('checkout', compact('subTotal', 'discount', 'tax', 'shippingCost', 'totalCost'));
}
