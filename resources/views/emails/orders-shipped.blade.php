...
___
```
Item Subtotal:       Rp.{{ $order->grand_total }}
Shipping & Handling: Rp.{{ $extra =  $order->grand_total < 10 ? 5 : 0 }}
POD Convenience Fee: Rp.0
```
**Shipping Total:** &nbsp; &nbsp; &nbsp; &nbsp; **Rp.{{ $order->grand_total + $extra }}**
___
Track your order with the [Teknik App]({{ route('home') }}).
