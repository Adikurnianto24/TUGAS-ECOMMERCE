     ...
     <section class="_container">
         <aside>
            ...
            <div class="sort">
                <h3>Sort</h3>
                <ul>
                    <li style="color:{{'ASC' == $sort ? '#3da8f3':''}}" onclick="updateQuery('sort', 'ASC')">Price: Terendah to Tertinggi</li>
                    <li style="color:{{'DESC' == $sort ? '#3da8f3':''}}" onclick="updateQuery('sort', 'DESC')">Price: Tertinggi to Terendah</li>
                </ul>
            </div>
         </aside>
