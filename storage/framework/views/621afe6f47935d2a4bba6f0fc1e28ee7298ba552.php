<header>
    <nav class="flex_align _container">
        <a class="logo-link d-b" href="<?php echo e(route('home')); ?>"><img class="d-b" src="<?php echo e(asset('img/teknik.png')); ?>" alt="logo"></a>
...
</header><?php /**PATH C:\Users\hp\laravel-8-ecommerce\resources\views/components/header.blade.php ENDPATH**/ ?>